...
class Cached_Container extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'Yoast\\WP\\SEO\\Helpers\\Schema\\Language_Helper' => 'getLanguageHelperService',
